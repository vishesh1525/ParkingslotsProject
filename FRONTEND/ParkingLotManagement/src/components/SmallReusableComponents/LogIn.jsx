            ...
            <form className="mt-8 space-y-4">
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="mail_id" type="text" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter Mail Id" />
